...
![Alt text](plots/active_comp_i100_s100_loss_seqs.png?raw=true "Title")

2. 500 примеров

![Alt text](plots/active_comp_i500_s100_f1_seqs.png?raw=true "Title")

![Alt text](plots/active_comp_i500_s100_loss_seqs.png?raw=true "Title")

Сэмплирование новых примеров с учетом энтропии дает стабильный прирост в качестве модели на любом (протестированном) размере обучающего набора. Однако оно и увеличивает количество новых токенов, которые необходимо разметить, в силу того, что в среднем у длинных предложений энтропия выше. В моих экспериментах средняя длина сэмплированных предложений увеличивалась на 35% при использовании NSE в сравнении с рандомным сэмплированием.

Однако если учесть сложность разметки (количество новых токенов с метками, отличными от "O"), то прирост оказывается не таким большим:

1. Начальный размер - 100 примеров

![Alt text](plots/active_comp_i100_s100_f1_tags.png?raw=true "Title")

2. Начальный размер - 500 примеров

![Alt text](plots/active_comp_i500_s100_f1_tags.png?raw=true "Title")

Причиной этому может быть неинформативность токенов, не входящих в именованные сущности. Как следствие - низкая энтропия примеров, содержащих меньше сущностей.
